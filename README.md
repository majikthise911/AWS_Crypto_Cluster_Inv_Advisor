...
3. Inside your local git repository, create a directory for the challenge assignment you choose. Use folder names corresponding to: **RoboAdvisor** or **ClusteringCrypto**.

4. Add solutions files to this folder.
...
I combine Amazon Web Services skills with Python, to create a bot that will recommend an investment portfolio for a retirement plan.
...
[Big Four firm](https://en.wikipedia.org/wiki/Big_Four_accounting_firms). This repo seeks to enhance clarity of the crypto market by generating a report of what cryptocurrencies are available on the trading market and how they can be grouped using classification.

We will use unsupervivsed learning and Amazon SageMaker skills by clustering cryptocurrencies and creating plots to present results.
